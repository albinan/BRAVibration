...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.headerlines_label = QtWidgets.QLabel(Dialog)
        self.headerlines_label.setObjectName("headerlines_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.headerlines_label)
        self.headerlines_edit = QtWidgets.QLineEdit(Dialog)
        self.headerlines_edit.setEnabled(False)
        self.headerlines_edit.setObjectName("headerlines_edit")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.headerlines_edit)
        self.dataFormat_label = QtWidgets.QLabel(Dialog)
        self.dataFormat_label.setObjectName("dataFormat_label")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.dataFormat_label)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.dataFormat_edit)
        self.sliceData_label = QtWidgets.QLabel(Dialog)
        self.sliceData_label.setObjectName("sliceData_label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.sliceData_label)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.sliceData_check)
        self.sliceMode_label = QtWidgets.QLabel(Dialog)
        self.sliceMode_label.setObjectName("sliceMode_label")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.sliceMode_label)
        ...
        self.sliceMode_combo.addItem("")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.sliceMode_combo)
        self.slices_label = QtWidgets.QLabel(Dialog)
        self.slices_label.setObjectName("slices_label")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.slices_label)
        self.slices_spin = QtWidgets.QSpinBox(Dialog)
        self.slices_spin.setEnabled(False)
        self.slices_spin.setObjectName("slices_spin")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.slices_spin)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.LabelRole, self.scaleTime_label)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.scaleTime_edit)
        self.unitAcc_label = QtWidgets.QLabel(Dialog)
        self.unitAcc_label.setObjectName("unitAcc_label")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.unitAcc_label)
        self.unitAcc_combo = QtWidgets.QComboBox(Dialog)
        self.unitAcc_combo.setObjectName("unitAcc_combo")
        self.unitAcc_combo.addItem("")
        self.unitAcc_combo.addItem("")
        self.unitAcc_combo.addItem("")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.unitAcc_combo)
        self.scaleAcc_label = QtWidgets.QLabel(Dialog)
        self.scaleAcc_label.setObjectName("scaleAcc_label")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.scaleAcc_label)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.scaleAcc_edit)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.headerlines_label.setText(_translate("Dialog", "Headerlines"))
        self.headerlines_edit.setText(_translate("Dialog", "0"))
