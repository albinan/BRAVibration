...
class window(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        hbox_main = QtWidgets.QHBoxLayout(self)
        vbox_left = QtWidgets.QVBoxLayout()
        ## Box with interval settings
        vbox_intervals = QtWidgets.QVBoxLayout()

        hbox_finterval = QtWidgets.QHBoxLayout()

        label_finterval = QtWidgets.QLabel('Frekvensintervall (Hz)')
        edit_finterval = QtWidgets.QTextEdit('20.0,30.0,0.5')

        hbox_finterval.addWidget(label_finterval)
        hbox_finterval.addWidget(edit_finterval)

        vbox_intervals.addLayout(hbox_finterval)

        hbox_ginterval = QtWidgets.QHBoxLayout()

        vbox_main.addLayout(vbox_intervals)
        #self.master = master
